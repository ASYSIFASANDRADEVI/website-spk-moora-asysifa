...
<head>
  ...
  <style>
    /* Custom Background Gradient Soft Pink / Magenta untuk Sidebar */
    .bg-gradient-pink {
      background-color: #d81b60;
      background-image: linear-gradient(180deg, #d81b60 0%, #a8286a 100%);
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    ?>
      ...
      <li class="nav-item <?php if($page == "Rank"){echo "active";} ?>">
      ...
      <li class="nav-item <?php if($page == "Ulasan"){echo "active";} ?>">
        <a class="nav-link" href="ulasan_pengguna.php">
          <i class="fa fa-comments"></i>
          <span>Data Ulasan Produk</span></a>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="backupdata.php">Backup Database</a>          
                <a class="collapse-item" href="restoredata.php">Restore Database</a>
            </div>
        </div>
      </li>
    ...
    ?>
      ...
      <li class="nav-item <?php if($page == "Pemilihan"){echo "active";} ?>">
        <a class="nav-link" href="pemilihan-produk.php">
          <i class="fa fa-check-square"></i>
          <span>Pemilihan Produk</span></a>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <button id="sidebarToggleTop" class="btn text-pink-custom d-md-none rounded-circle mr-3">
